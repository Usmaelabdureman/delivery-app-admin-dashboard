  ...
  if (!session) {
    return (
      <div className="bg-slate-800 min-h-screen flex items-center justify-center">
        <div class="grid grid-rows-3  gap-4  justify-center items-center">
          <div class="row-span-3 ">          <h1 className="text-3xl font-bold text-white mb-4">Welcome to Delivery App Admin Dashboard</h1></div>
          <div class="row-span-2 "> 
          <h2 className="text-xl m-3 ml-3 text-teal-500">Please login to Access the dashboard!</h2></div>
          <div class="row-span-2 ">        
